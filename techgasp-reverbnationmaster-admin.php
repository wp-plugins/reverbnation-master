<div class="wrap">
<div class="icon32" style="width:40px; vertical-align:middle;"><img src="../wp-content/plugins/reverbnation-master/techgasp-minilogo.png" alt="' . esc_attr__( 'TechGasp Plugins') . '" /><br /></div>

<h2><b>TechGasp - Reverbnation Master Lite Version</b></h2>
<form method="post" action="techgasp-reverbnationmaster-admin.php"> 
...
<img src="../wp-content/plugins/reverbnation-master/techgasp-reverbnationmaster-logo.png" alt="Reverbnation Master" align="left" width="387px" height="171px" style="padding:5px;"/>
<p><h2>Reverbnation Master:</h2></p>
<p>Reverbnation Master plugs-in perfectly into wordpress and allows you to display all the reverbnation juice inside any widget template position.</p>
</br>
<p><em>independent music for wordpress..</em><p>
</br>
</br>
<p><h3>Options & Configuration:</h3></p>
<p><b>All configuration options are available in your widgets page. Reverbnation Master Widget:</b></p>
<p>Select or <em>"add"</em > Reverbnation Master Widget. Configure your settings. Select widget position according to your template. That easy...</p>
<p><b>Insert Reverbnation Master Widget inside Pages and Posts (advanced version only):</b></p>
<p>Copy and Paste this shortcode inside your pages or posts [reverbnationmaster id=xx] replace xx with your sidebar number, ie [reverbnationmaster id=sidebar-1]</p>
<p><a class="button-primary" href="widgets.php" title="Widgets Page">To Widgets Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/reverbnation-master/" target="_blank" title="More Help">More Help</a> <a class="button-primary" href="http://wordpress.techgasp.com/reverbnation-master/" target="_blank" title="Reverbnation Master Advanced Version">Reverbnation Master Advanced Version</a></p>
<hr>
<p><h3>Reverbnation Master Advanced Version:</h3></p>
<p>Display or hide Widget Title. Cool transparent Reverbnation Profile Button. Reverbnation Widget Player (full nine yards api Player. Displays all Reverbnation Widgets, Html5 Player, Html5 Fan Collector, Html5 Show Schedule, Tune Widget, Shop, etc. Shortcode Framework. Publish widget inside pages and posts.</p>
