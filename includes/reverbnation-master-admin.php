...
<tr>
<td width="387">
<img src="<?php echo plugins_url('../images/techgasp-reverbnationmaster-logo.png', __FILE__); ?>" alt="Reverbnation Master" align="left" width="387px" height="171px" style="padding:5px;"/>
</td>
<td width="0,5"></td>
<td width="700">
...
<h2><?php _e("Reverbnation Master LITE Version", 'reverbnation_master'); ?></h2>
<br>
<form method="post" width='1'>
<fieldset class="options">
<legend><h3><img src="<?php echo plugins_url('../images/techgasp-minilogo-16.png', __FILE__); ?>" style="float:left; height:16px; vertical-align:middle;" /><?php _e('&nbsp;Advanced Version Updater:', 'reverbnation_master'); ?></h3></legend>
<br>
<div class="description">Only available in <b>Reverbnation Master Advanced Version</b></div>
</fieldset>
<p class="submit"><input class='button-primary' type='submit' name='update' value='<?php _e("Save Settings", 'reverbnation_master'); ?>' id='submitbutton' /></p>
...
<div class="description">All <b>LITE</b> widget options are available in your widgets page. <b>Reverbnation Master Widget</b>.</div>
...
<div class="description">The shortcode framework allows you to insert Reverbnation Master inside Pages & Posts without the need of extra plugins or gimmicks. Fast page load times and top SEO. Only available in <b>Reverbnation Master Advanced Version</b>.</div>
<br>
<div style="background: url(<?php echo plugins_url('../images/techgasp-hr.png', __FILE__); ?>) repeat-x; height: 10px"></div>

<h3><img src="<?php echo plugins_url('../images/techgasp-minilogo.png', __FILE__); ?>" style="width:40px; vertical-align:middle;" alt="' . esc_attr__( 'TechGasp Plugins') . '" /> Reverbnation Master Website</h3>
<p><a class="button-secondary" href="http://wordpress.techgasp.com/reverbnation-master/" target="_blank" title="Reverbnation Master Info Page">Info Page</a> <a class="button-secondary" href="http://wordpress.techgasp.com/reverbnation-master-documentation/" target="_blank" title="Reverbnation Master Documentation">Documentation</a> <a class="button-primary" href="http://wordpress.techgasp.com/reverbnation-master/" target="_blank" title="Reverbnation Master Advanced Version">Advanced Version</a></p>
</form>
</div>