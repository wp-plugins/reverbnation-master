...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-reverbnationmaster-admin-widget-buttons.png', __FILE__); ?>" alt="<?php echo get_option('reverbnation_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
